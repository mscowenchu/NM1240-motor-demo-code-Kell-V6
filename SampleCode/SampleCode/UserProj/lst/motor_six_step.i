# 1 "program/motor_six_step.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "program/motor_six_step.c" 2
...
void SIX_STEP_CHANGE_PHASE_FW(void)
{
    ...
    {
        case 5:
            Trigger_update_micro_fig();

            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PHCHG = 0x00703E21 ;;

            if(0)
            {
                MotorA.other.i32_Capture_Value_Q15 = (signed short int)(((((ECAP_T *) ((( uint32_t)0x40100000) + 0xB0000))->HLD[0]-0xF80000) & 0x00FFFFFF)>>4);
                HallSpeedEstimator(&MotorA);
            }
            else if(1)
            {
                MotorA.other.i32_Capture_Value_Q15 = (signed short int)((((ECAP_T *) ((( uint32_t)0x40100000) + 0xB0000))->HLD[0] & 0x00FFFFFF)>>4);
                HallSpeedEstimator(&MotorA);
            }
        ...
        case 1:
            ...
            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PHCHG = 0x00703B24 ;;

            if(1)
            {
                MotorA.other.i32_Capture_Value_Q15 = (signed short int)((((ECAP_T *) ((( uint32_t)0x40100000) + 0xB0000))->HLD[2] & 0x00FFFFFF)>>4);
                HallSpeedEstimator(&MotorA);
            }
        ...
        case 3:
            ...
            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PHCHG = 0x00703B06 ;;

            if(1)
            {
                MotorA.other.i32_Capture_Value_Q15 = (signed short int)((((ECAP_T *) ((( uint32_t)0x40100000) + 0xB0000))->HLD[1] & 0x00FFFFFF)>>4);
                HallSpeedEstimator(&MotorA);
            }
        ...
        case 2:
            ...
            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PHCHG = 0x00702F12 ;;
        ...
        case 6:
            ...
            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PHCHG = 0x00702F18 ;;
        ...
        case 4:
            ...
            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PHCHG = 0x00703E09 ;;
