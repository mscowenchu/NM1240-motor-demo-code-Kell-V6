# 1 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/gpio.c" 2
# 12 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/gpio.c"
...
# 13 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/gpio.c" 2

static uint32_t volatile * const s_pu32INTEN[6] = {&((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00000))->INTEN, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040))->INTEN, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00080))->INTEN, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x000C0))->INTEN, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00100))->INTEN, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00140))->INTEN};
static uint32_t volatile * const s_pu32INTTYPE[6] = {&((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00000))->INTTYPE, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040))->INTTYPE, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00080))->INTTYPE, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x000C0))->INTTYPE, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00100))->INTTYPE, &((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00140))->INTTYPE};
# 51 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/gpio.c"
void GPIO_SetMode(GPIO_T *port, uint32_t u32PinMask, uint32_t u32Mode)
{
    uint32_t i;
...
# 86 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/gpio.c"
void GPIO_EnableInt(GPIO_T *port, uint32_t u32Pin, uint32_t u32IntAttribs)
{
    uint32_t u32Value;
    uint32_t u32Idx;
    ...
    u32Idx = (((uint32_t)port & 0x1FF) / ((uint32_t)((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040))-(uint32_t)((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00000))));
...
# 121 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/gpio.c"
void GPIO_DisableInt(GPIO_T *port, uint32_t u32Pin)
{
    uint32_t u32Idx;
