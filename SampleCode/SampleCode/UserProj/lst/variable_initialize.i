# 1 "program/variable_initialize.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "program/variable_initialize.c" 2
...
# 5 "program\\system_parameter.h" 2
...
# 4 "program/variable_initialize.c" 2
...
# 8 "program/variable_initialize.c" 2
...
# 9 "program/variable_initialize.c" 2
...
uint16_t u16_timer0_int_counter, u16_1ms_timer_counter, u16_10ms_time_counter, u16_100ms_time_counter, u16_500ms_time_counter;
...
PICs PI_Iq = {0,0,(5000)/10,(1000)/20},
     PI_Id = {0,0,(5000)/10,(1000)/20},
     PI_Speed = {0,0,(327678 * 0.5),(32768 * 0.0001)};
...
void Initialize_Variabls(void)
{
    ...
    MotorA.spec.i16_freq_pwm = 15000;
    MotorA.spec.i16_speed_loop_time = 1;
    MotorA.spec.i16_dead_time = (uint32_t)(1*60000000/1000000);
    MotorA.spec.i16_speed_slope_cnt_target = (1000*25)/500;
    MotorA.spec.i16_speed_slope_delta_rpm = 25;
    MotorA.spec.i16_current_gain = ((float)((float)100)*((float)4.99)*(float)4096*(32768/((float)4096/1))/1000/((float)5/2));
    MotorA.spec.i16_Idc_over_current = (float)5;
    MotorA.spec.i16_Idc_OC_Q15_max = (((float)((float)100)*((float)4.99)*(float)4096*(32768/((float)4096/1))/1000/((float)5/2))*(float)5);
    MotorA.spec.i16_Iphase_OC_Q15_max = 5 * ((float)((float)100)*((float)4.99)*(float)4096*(32768/((float)4096/1))/1000/((float)5/2));
    MotorA.spec.i16_Vq_maximum = 31000;
    MotorA.spec.i16_Iq_current_limit_in_A = (float)2.5;
    MotorA.spec.i16_Iq_current_limit = ((float)2.5 * ((float)((float)100)*((float)4.99)*(float)4096*(32768/((float)4096/1))/1000/((float)5/2)));
    MotorA.spec.i16_speed_maximum = 3000;
    MotorA.spec.i16_motor_pole = 4;
    ...
    MotorA.cmd.i16_Vb = 0;
    MotorA.cmd.i16_Vc = 0;
    MotorA.cmd.i16_Duty0 = 0;
    MotorA.cmd.i16_Duty2 = 0;
    MotorA.cmd.i16_Duty4 = 0;
    ...
    MotorA.cmd.u8_direction = (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x04000) + 0x00800)+(0x40*(0))) + ((6)<<2))));



    MotorA.ctrl.i32_Iq_control_limit_dig = MotorA.spec.i16_Vq_maximum;
    MotorA.ctrl.i32_Iq_control_limit_dig_ui = MotorA.ctrl.i32_Iq_control_limit_dig << 15;

    MotorA.ctrl.i32_Id_control_limit_dig = 10233;
    ...
    MotorA.ctrl.i16_maximum_speed_limit = 3000;
    ...
    MotorA.other.i32_Hall_Step_Theda_EST_Constatnt = (32768 << 11)/4*4/15000/(120/4);


    MotorA.other.i32_Hall_Wr_EST_Constant = ((60000000/16*60/(32/2))) / 4;
    if(0)
        MotorA.other.i32_Hall_Wr_EST_Constant = MotorA.other.i32_Hall_Wr_EST_Constant / 2;
    if(1)
        MotorA.other.i32_Hall_Wr_EST_Constant = MotorA.other.i32_Hall_Wr_EST_Constant / 6;

    MotorA.other.u8_flag_ECAP_overflow = 0;

    MotorA.other.ui16_initial_hall_change_cnt = 0;

    MotorA.other.u8_operation_state = 0;
    MotorA.other.u8_Motor_Running_State = 0;
    MotorA.other.u8_CMD_Motor_Action = 0;
    MotorA.other.u8_flag_error_record = 0;

    MotorA.other.ui16_speed_slope_counter = 0;
    MotorA.other.ui16_VSP_12bit_ADC = 0;

    MotorA.other.u8_flag_need_read_VSP = 0;
}
...
{
# 213 "program/variable_initialize.c"
    MotorA.cmd.i16_Id = 0;
    MotorA.cmd.i16_Iq = 0;
    MotorA.cmd.i16_Vd = 0;
    MotorA.cmd.i16_Vq = 0;
    ...
    MotorA.cmd.u8_start = 0;
    MotorA.cmd.u8_direction = (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x04000) + 0x00800)+(0x40*(0))) + ((6)<<2))));
# 253 "program/variable_initialize.c"
    MotorA.sym.u8_zero_current_error = 0;
    MotorA.sym.u8_Idc_OC_error = 0;
    MotorA.sym.u8_Iphase_OC_error = 0;
# 276 "program/variable_initialize.c"
    MotorA.other.u8_Motor_Running_State = 0;
    MotorA.other.u8_CMD_Motor_Action = 0;
