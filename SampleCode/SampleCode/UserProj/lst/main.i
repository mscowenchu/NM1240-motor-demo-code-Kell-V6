...
volatile int32_t t1, t2, t3, t4;
volatile int32_t counter_flash_LED = 0;
...
int main()
{
    ...
    Initialize_FMC();
    Initialize_USCI_UART();
    Initialize_ECAP();
    Initialize_ADC();
    Initialize_OP1();
    Initialize_ACMP0((((float)((float)1200 + (float)6200) / ((float)1200 + (float)36000) * (float)5 * (float)4096 / (float)5) + ((float)((float)1200 + (float)6200) / ((float)1200 + (float)36000) * (float)36000 / (float)1200 * (float)(2.5) * ((float)100) / 1000 * (float)4096 / (float)5)));
    Initialize_Timer0();
    Initialize_GPIO();
    Initialize_HDIV();
...
# 104 "program/main.c"
    while(1)
    {
        ...
        {
            if(counter_flash_LED < 50)
            {
                delay_Xmsec(70);
                (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x04000) + 0x00800)+(0x40*(5))) + ((4)<<2)))) ++;
                counter_flash_LED ++;
            }
            else
            {
