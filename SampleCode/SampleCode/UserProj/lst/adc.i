# 1 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c" 2
# 11 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c"
...
# 12 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c" 2
# 34 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c"
void ADC_Open(ADC_T *adc, uint32_t u32InputMode)
{
    adc->CTL |= (0x1ul << (0));
}
...
void ADC_Close(ADC_T *adc)
{
    ...
    adc->CTL &= ~(0x1ul << (0));
    SYS_ResetModule(((0x1ul << (28))));
}
# 162 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c"
                           ...
                           uint32_t u32TriggerSrc)
{
   ...
   ADC0TriggerSrc = u32TriggerSrc & ((0x3ul << (6)) | (0x3ul << (4)) | (0xful << (0)));
   ADC1TriggerSrc = u32TriggerSrc & ((0x3ul << (22)) | (0x3ul << (20)) | (0xful << (16)));

    if (ADC0TriggerSrc == (0x000000FFUL))
        adc->CTL &= ~(0x1ul << (2));
    else
    {
       adc->TRGSOR = (adc->TRGSOR & ~((0x3ul << (6)) | (0x3ul << (4)) | (0xful << (0))))
                   | ADC0TriggerSrc;
      adc->CTL |= (0x1ul << (2));
  }
    if (ADC1TriggerSrc == (0x00FF0000UL))
        adc->CTL &= ~(0x1ul << (10));
    else
    {
        adc->TRGSOR = (adc->TRGSOR & ~((0x3ul << (22)) | (0x3ul << (20)) | (0xful << (16))))
                  | ADC1TriggerSrc;
      adc->CTL |= (0x1ul << (10));
  }
}
# 202 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c"
void ADC_SetTriggerDelayTime(ADC_T *adc,
                            uint32_t u32ModuleNum,
                            uint32_t u32TriggerDelayTime)
{
    if (u32ModuleNum == (0))
        adc->TRGDLY = (adc->TRGDLY & (~(0xfful << (0)))) | ((u32TriggerDelayTime & 0xFF) << (0));
    else if (u32ModuleNum == (16))
        adc->TRGDLY = (adc->TRGDLY & (~(0xfful << (16)))) | ((u32TriggerDelayTime & 0xFF) << (16));
}
# 222 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c"
void ADC_SetSampleCnt(ADC_T *adc, uint32_t u32ModuleNum, uint32_t u32SampleCnt)
{
    adc->SMPCNT = (adc->SMPCNT & (~(0xful << (0)))) | ((u32SampleCnt & 0xF) << (0));
}
# 239 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c"
uint32_t ADC_Get_Data_Valid_Flag(ADC_T *adc, uint32_t u32Channel)
{
    uint32_t valid_flag;
...
# 257 "C:/Users/JPChang0/Desktop/nuvoTon/!Project-NuMotor Solution/!Development of NM1244/[Example Code] NuMotor NM1240_Rev4.1_20250806/SW/Library/StdDriver/src/adc.c"
uint32_t ADC_GET_INT_FLAG(ADC_T *adc, uint32_t u32Msk)
{
