# 1 "program/motor_funtions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "program/motor_funtions.c" 2
...
# 3 "program/motor_funtions.c" 2
# 1 "program\\motor_six_step.h" 1
# 37 "program\\motor_six_step.h"
extern void SIX_STEP_CHANGE_PHASE_FW(void);
extern void SIX_STEP_CHANGE_PHASE_RW(void);
# 4 "program/motor_funtions.c" 2
...
void PhaseCurrent_OC_Check(AMotor* Motor)
{
    ...
    iu = ((Motor->info.i16_Iu)>=0 ? (Motor->info.i16_Iu) : -(Motor->info.i16_Iu));
    iv = ((Motor->info.i16_Iv)>=0 ? (Motor->info.i16_Iv) : -(Motor->info.i16_Iv));
    iw = ((Motor->info.i16_Iw)>=0 ? (Motor->info.i16_Iw) : -(Motor->info.i16_Iw));

    if(iu > Motor->spec.i16_Iphase_OC_Q15_max)
    {
        Stop_Motor_PWMOUT_OFF();
        Motor->sym.u8_Iphase_OC_error |= 2;
        Motor->other.u8_flag_error_record |= 0x02;
    }
    else if(iv > Motor->spec.i16_Iphase_OC_Q15_max)
    {
        Stop_Motor_PWMOUT_OFF();
        Motor->sym.u8_Iphase_OC_error |= 4;
        Motor->other.u8_flag_error_record |= 0x04;
    }
    else if(iw > Motor->spec.i16_Iphase_OC_Q15_max)
    {
        Stop_Motor_PWMOUT_OFF();
        Motor->sym.u8_Iphase_OC_error |= 8;
        Motor->other.u8_flag_error_record |= 0x08;
    }
}
...
void HallSpeedEstimator(AMotor* Motor)
{
    ...
    if((i32_Capture_Value_Q15 > 0x7FF0) || (Motor->other.u8_flag_ECAP_overflow == 1))
    {
        speed_now = 0;
    }
    ...
    else
    {
        ...
        {
            ((HDIV_T *) ((( uint32_t)0x50000000) + 0x14000))->DIVIDEND = (int32_t) i32_Hall_Wr_EST_Constant;
            ((HDIV_T *) ((( uint32_t)0x50000000) + 0x14000))->DIVISOR = i32_Capture_Value_Q15;
            __builtin_arm_nop();
            __builtin_arm_nop();
            speed_now = (int16_t) ((HDIV_T *) ((( uint32_t)0x50000000) + 0x14000))->QUOTIENT;
        }
        else
        {
            speed_now = 0;
    ...
    if(speed_now <= 1)
    {
        Motor->other.u8_operation_state = 0;
        Fix_Phase_Angle_M0(85);
    }


    if((Motor->other.u8_flag_do_speed_average == 0) && (speed_now > (300 + 100)))
        Motor->other.u8_flag_do_speed_average = 1;
    else if((Motor->other.u8_flag_do_speed_average == 1) && (speed_now < (300 - 100)))
...
void Detect_Initial_Hall_Position_M0(void)
{
    ...
    Hall_Position = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00140))->PIN & 0x07);
    Last_Hall_Position = Hall_Position;
    Forward_Direction_CMD_M0 = MotorA.cmd.u8_direction;

    Initial_Shift_Angle = 1024*0/360;

    if(Hall_Position != 0 && Hall_Position != 7)
    {
        Hall_Accumulated_Theda_Q26 = MotorA.other.i32_Hall_Accumulated_Theda_Q26;

        if(Forward_Direction_CMD_M0 == 1)
        {
            switch(Hall_Position)
            {
                case 5:

                    MotorA.info.i16_hall_angle = 1024*( 90+0)/360 + (1024*180/360) + Initial_Shift_Angle;
                ...
                case 1:
                    ...
                    MotorA.info.i16_hall_angle = 1024*(150+0)/360 + (1024*180/360) + Initial_Shift_Angle;
                ...
                case 3:
                    MotorA.info.i16_hall_angle = 1024*(210+0)/360 + (1024*180/360) + Initial_Shift_Angle;
                    if(MotorA.info.i16_hall_angle > 1023)
                        MotorA.info.i16_hall_angle = MotorA.info.i16_hall_angle - 1024;
                    else if (MotorA.info.i16_hall_angle < 0)
                        MotorA.info.i16_hall_angle = MotorA.info.i16_hall_angle + 1024;
                ...
                case 2:
                    ...
                    MotorA.info.i16_hall_angle = 1024*(270+0)/360 + (1024*180/360) + Initial_Shift_Angle;
                ...
                case 6:
                    ...
                    MotorA.info.i16_hall_angle = 1024*(330+0)/360 + (1024*180/360) + Initial_Shift_Angle;
                ...
                case 4:
                    ...
                    MotorA.info.i16_hall_angle = 1024*( 30+0)/360 + (1024*180/360) + Initial_Shift_Angle;
        ...
        else
        {
            switch(Hall_Position)
            {
                ...
                case 3:
                    ...
                    MotorA.info.i16_hall_angle = 1024*(-270+0)/360 + Initial_Shift_Angle;
                    if(MotorA.info.i16_hall_angle > 1023)
                        MotorA.info.i16_hall_angle = MotorA.info.i16_hall_angle - 1024;
                    else if (MotorA.info.i16_hall_angle < 0)
                        MotorA.info.i16_hall_angle = MotorA.info.i16_hall_angle + 1024;
                ...
                case 1:
                    ...
                    MotorA.info.i16_hall_angle = 1024*(-330+0)/360 + Initial_Shift_Angle;
                ...
                case 5:
                    ...
                    MotorA.info.i16_hall_angle = 1024*( -30+0)/360 + Initial_Shift_Angle;
                ...
                case 4:
                    ...
                    MotorA.info.i16_hall_angle = 1024*( -90+0)/360 + Initial_Shift_Angle;
                ...
                case 6:
                    ...
                    MotorA.info.i16_hall_angle = 1024*(-150+0)/360 + Initial_Shift_Angle;
                ...
                case 2:
                    ...
                    MotorA.info.i16_hall_angle = 1024*(-210+0)/360 + Initial_Shift_Angle;
...
uint8_t Check_Rotor_FW_RW_M0(uint8_t u8_Last_Hall_Pos, uint8_t u8_Hall_Pos, uint8_t u8_Last_Direction)
{
    ...
    u8_Rotor_Direction_M0 = u8_Last_Direction;

    switch(u8_Last_Hall_Pos)
    {
        case 5:
            if(u8_Hall_Pos == 1)
                u8_Rotor_Direction_M0 = 1;
            else if(u8_Hall_Pos == 4)
                u8_Rotor_Direction_M0 = 0;
        break;

        case 1:
            if(u8_Hall_Pos == 3)
                u8_Rotor_Direction_M0 = 1;
            else if(u8_Hall_Pos == 5)
                u8_Rotor_Direction_M0 = 0;
        break;
    ...
    if(Forward_Direction_CMD_M0 == 1)
    {
        switch(Hall_Position)
        {
            case 5:
                ...
                MotorA.info.i16_hall_angle = 1024*( 90+0)/360 + (1024*180/360) + i16_Shift_Angle;
            ...
            case 1:
                ...
                MotorA.info.i16_hall_angle = 1024*(150+0)/360 + (1024*180/360) + i16_Shift_Angle;
            ...
            case 3:
                ...
                MotorA.info.i16_hall_angle = 1024*(210+0)/360 + (1024*180/360) + i16_Shift_Angle;
            ...
            case 2:
                ...
                MotorA.info.i16_hall_angle = 1024*(270+0)/360 + (1024*180/360) + i16_Shift_Angle;
            ...
            case 6:
                ...
                MotorA.info.i16_hall_angle = 1024*(330+0)/360 + (1024*180/360) + i16_Shift_Angle;
            ...
            case 4:
                ...
                MotorA.info.i16_hall_angle = 1024*( 30+0)/360 + (1024*180/360) + i16_Shift_Angle;
    ...
    else
    {
        switch(Hall_Position)
        {
            case 3:
                ...
                MotorA.info.i16_hall_angle = 1024*(-270+0)/360 - i16_Shift_Angle;
            ...
            case 1:
                ...
                MotorA.info.i16_hall_angle = 1024*(-330+0)/360 - i16_Shift_Angle;
            ...
            case 5:
                ...
                MotorA.info.i16_hall_angle = 1024*( -30+0)/360 - i16_Shift_Angle;
            ...
            case 4:
                ...
                MotorA.info.i16_hall_angle = 1024*( -90+0)/360 - i16_Shift_Angle;
            ...
            case 6:
                ...
                MotorA.info.i16_hall_angle = 1024*(-150+0)/360 - i16_Shift_Angle;
            ...
            case 2:
                ...
                MotorA.info.i16_hall_angle = 1024*(-210+0)/360 - i16_Shift_Angle;
...
void cmd_speed_slope_with_hall(AMotor* Motor)
{
    ...
    temp_cnt_value = Motor->spec.i16_speed_slope_cnt_target;
    delta_rpm = Motor->spec.i16_speed_slope_delta_rpm;
    counter = Motor->other.ui16_speed_slope_counter;

    if(Motor->other.u8_operation_state == 0 )
    {
...
# 673 "program/motor_funtions.c"
void read_VSP_Check_ON_OFF_Motor(AMotor* Motor)
{
    int32_t VSP;

    if(Motor->other.u8_flag_error_record != 0)
    {
        Set_EPWM_MASK_Enable((~0x3F));
        return;
    }
    ...
    else
    {
        if(VSP >= 600)
        {
            ...
            Start_Motor_PWMOUT_ON(((60000000/2)/15000)/2, ((60000000/2)/15000)/2, ((60000000/2)/15000)/2);
# 719 "program/motor_funtions.c"
            MotorA.cmd.u8_start = 1;
            MotorA.other.u8_CMD_Motor_Action = 2;
            MotorA.other.u8_Motor_Running_State = 2;
        }
    }
}
...
void read_UART_Check_ON_OFF_Motor(AMotor* Motor)
{
    ...
    if(Motor->cmd.u8_start == 1 && MotorA.other.u8_CMD_Motor_Action == 0 )
    {



        Start_Motor_PWMOUT_ON(((60000000/2)/15000)/2, ((60000000/2)/15000)/2, ((60000000/2)/15000)/2);
# 768 "program/motor_funtions.c"
        MotorA.other.u8_CMD_Motor_Action = 2;
        MotorA.other.u8_Motor_Running_State = 2;
    }
}
# 780 "program/motor_funtions.c"
void read_VSP_to_duty_cmd(AMotor* Motor)
{
    ...
    if(Motor->cmd.u8_start == 1)
    {
        ...
        {
            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMPDAT[0]=0;
            u16_Duty_VSP = 0;
        }


        cmd_duty = ((60000000/2)/15000)*VSP>>12;

        if(cmd_duty > (((60000000/2)/15000) - (uint32_t)(((60000000/2)/15000)*0.065)))
            cmd_duty = (((60000000/2)/15000) - (uint32_t)(((60000000/2)/15000)*0.065));
        else if(cmd_duty < 0)
            cmd_duty = 0;

        if(((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMPDAT[0]<cmd_duty)
        {
            dDuty=50;
            u16_Duty_VSP += dDuty;
            ...
            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMPDAT[0] = u16_Duty_VSP;
            Motor->cmd.i16_Duty0 = Motor->cmd.i16_Duty2 = Motor->cmd.i16_Duty4 = cmd_duty;
        }
        else
        {
            ((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMPDAT[0] = cmd_duty ;
            Motor->cmd.i16_Duty0 = Motor->cmd.i16_Duty2 = Motor->cmd.i16_Duty4 = cmd_duty;
        }
    }
}
...
void read_VSP_to_speed_cmd(AMotor* Motor)
{
    ...
    if(Motor->other.u8_CMD_Motor_Action == 2)
    {

        cmd_speed_target = (((unsigned long)(VSP - 600) * ((3000 - 200)*32768/(4095 - 600))) >> 15) + 200;

        if(cmd_speed_target > 3000)
            cmd_speed_target = 3000;
        else if(cmd_speed_target < 200)
            cmd_speed_target = 200;
...
void read_VSP_to_Iq_cmd(AMotor* Motor)
{
    ...
    if(Motor->cmd.u8_start == 1)
    {
        ...
        if(MotorA.cmd.u8_direction == 0)
            Motor->cmd.i16_Iq = -Motor->cmd.i16_Iq;
    }
}
...
# 913 "program/motor_funtions.c"
    tempB = ((MotorA.info.i16_Iv*4 + 32768) >> 4)&0x0FFF;
# 927 "program/motor_funtions.c"
...
{
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x04000) + 0x00800)+(0x40*(3))) + ((6)<<2)))) = 1;


    while(((((USPI_T *) ((( uint32_t)0x40100000) + 0x70000))->PROTSTS & (0x1ul << (17))) >> (17)) == 1);

    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x04000) + 0x00800)+(0x40*(3))) + ((6)<<2)))) = 0;

    (((USPI_T *) ((( uint32_t)0x40100000) + 0x70000))->TXDAT) = 0x8000 | tempA;
...
}
{
    ...
    (((USPI_T *) ((( uint32_t)0x40100000) + 0x70000))->TXDAT) = 0x9000 | tempB;
...
}
{
    ...
    (((USPI_T *) ((( uint32_t)0x40100000) + 0x70000))->TXDAT) = 0xA000 | tempC;
...
}
{
    ...
    (((USPI_T *) ((( uint32_t)0x40100000) + 0x70000))->TXDAT) = 0xB000 | tempD;
...
void DAC_Module_Check(void)
{
    ...
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x04000) + 0x00800)+(0x40*(3))) + ((6)<<2)))) = 0;
    (((USPI_T *) ((( uint32_t)0x40100000) + 0x70000))->TXDAT) = 0xF000 | 0x800;
...
void delay_Xmsec(unsigned int z)
{
    uint32_t i;
    uint32_t j;
...
void DAC_Output_M0_1R(void)
{
    ...
    tempA = ( (((EPWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PHCHG &0xff) <<4)&0x0FFF;
...
# 1224 "program/motor_funtions.c"
void Enable_CLKO_to_PA0(void)
{

    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP & ~(0xful << (0))) | (0x1UL<<(0));
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00000))->MODE = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00000))->MODE & ~(0x3ul << (0))) | (0x1UL << (0));


    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK |= (0x1ul << (6));


    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 &~ (0x3ul << (30))) | (0x02UL<<(30));
