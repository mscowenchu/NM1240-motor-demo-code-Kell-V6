# 1 "program/PI_control.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "program/PI_control.c" 2
...
# 5 "program\\system_initialize.h" 2
...
# 6 "program\\system_initialize.h" 2
...
int16_t PI_speed(AMotor* Motor, PICs* C, int16_t FW_Item)
{
    ...
    limit = Motor->ctrl.i32_Speed_control_limit_dig;
